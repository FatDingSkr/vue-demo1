<template>
    <div class="price">
        ...
        <div 
            ...
            :key="item[0].goodsId"
        >
            <img  width="115" height="115" :src="item[0].goodsImgPath" alt="">
            <div class="goods_desc" >
                ...
                <mt-button @click="addGoodInfo(item[0])" type="danger" size="small">购买</mt-button>
            </div>
...
export default {
    ...
    methods:{
        ...
        getMessage(){
            this.$http.get("http://39.107.136.192/bl/json/sort/price.json").then(res=>{
